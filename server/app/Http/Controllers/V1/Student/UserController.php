...
use App\Http\Requests\V1\Student\Auth\LoginRequest;
use App\Http\Requests\V1\Student\Auth\RegisterRequest;
use App\Http\Requests\V1\Student\Auth\VerifyPasswordRequest;
use App\Http\Requests\V1\Student\Auth\VerifyRequest;
